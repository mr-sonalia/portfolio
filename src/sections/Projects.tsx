...
const Project = ({ og, redirection, title, description }: ProjectProps) => {
	return (
		<a
			...
			<div className="flex items-start flex-col md:flex-row justify-start w-full p-4 bg-gray-50 dark:bg-night-400 rounded-sm border-solid border border-gray-200 dark:border-accent-800">
				<div
