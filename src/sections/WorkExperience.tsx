...
const WorkCard = ({ title, company, date, description }: WorkCardProps) => {
	return (
		<div className="flex flex-col items-start justify-start w-full p-4 bg-gray-50 dark:bg-night-400 rounded-lg border-solid border border-gray-200 dark:border-accent-800">
